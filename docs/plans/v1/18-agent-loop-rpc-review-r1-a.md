...
The existing codebase has `internal/rpc/api/types.go` importing `github.com/dcosson/flex-agent-runtime/internal/agent`, so `internal/agent` cannot import `internal/rpc/api`. Either:
